...
roborts_common::ErrorInfo LocalPlannerNode::Init() {
  ...
  // loacl_planner_state_pub_ = local_planner_nh_.advertise<std_msgs::Bool>("/local_planner_state", 2);
  // local_planner_state_.data = true;
...
void LocalPlannerNode::StartPlanning() {
  ...
  // local_planner_state_.data = true;
  // loacl_planner_state_pub_.publish(local_planner_state_);
}
...
void LocalPlannerNode::StopPlanning() {
  ...
  // local_planner_state_.data = false;
  // loacl_planner_state_pub_.publish(local_planner_state_);
}
