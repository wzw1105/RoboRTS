...
struct LocalizationConfig {
  void GetParam(ros::NodeHandle *nh) {
      ...
      nh->param<int>("time_range",time_range,150000000);
      nh->param<double>("dis_range",dis_range,1.0);
      nh->param<int>("fusion_time_start",fusion_time_start,175);
      nh->param<int>("fusion_time_end",fusion_time_end,65);
